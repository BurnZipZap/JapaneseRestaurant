...
public class MainController {
	...
	@GetMapping("/")
	public String getClaassicRollContent(Model model) {
		model.addAttribute("dishs", sushiHouseService.findDishByCategory("ClassicRoll"));
		return "main";
	}

	@GetMapping("/fry")
	public String getFryRollContent(Model model) {
		model.addAttribute("dishs", sushiHouseService.findDishByCategory("FryRoll"));
		return "main";
	}
	
	@GetMapping("/baked")
	public String getBakedRollContent(Model model) {
		model.addAttribute("dishs", sushiHouseService.findDishByCategory("BakedRoll"));
		return "main";
	}
	
	@GetMapping("/sushi")
	public String getSushiContent(Model model) {
		model.addAttribute("dishs", sushiHouseService.findDishByCategory("Sushi"));
		return "main";
	}
	
	@GetMapping("/other")
	public String getOtherContent(Model model) {
		model.addAttribute("dishs", sushiHouseService.findDishByCategory("Other"));
		return "main";
	}
